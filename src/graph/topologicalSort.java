...
class TopologicalSort {
	...
	private Set<Integer> retrieveZeroIndegreeVertex() {
		...
		// System.out.println("the indegree list is retrieveZeroIndegreeVertex
		// :" + indegreeList);
	...
	private void deleteZeroIndegreeVertex(Set<Integer> zeroIndegreeSet) {
		...
		for (Integer vertex : zeroIndegreeSet) {
			...
			// System.out.println("the indegree list is deleteZeroIndegreeVertex
			// :" + indegreeList);
